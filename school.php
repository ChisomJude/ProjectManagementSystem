                        ...
                        <div class="">
                            ...
                            // echo  $date= date('Y-m-d');
                             if(!isset($_POST['add_school'])){
                                   ...
                                   $q= "INSERT INTO `schools` (`id`, `agent_id`, `sch_name`, `sch_addr`, `sch_type`, `sch_size`,`lga`, `state`, `contact_name`,`contact_person_designation`,`email`, `phone`,`status`,`sch_records`,`date`)
                                            VALUES (NULL, '$agent', '$sch_name', '$sch_addr', '$type',$sch_size, '$lga', '$state', '$person', '$person_desig','$email', '$phone','0','0', '$date')";
                                                ...
                                                <?php
                                                    if($q= mysqli_query($con,$q)){
                                                        ...
                                                        <a href='all.php' title='View list of your schools'>View Schools</a></h4>";
                                            }else{
