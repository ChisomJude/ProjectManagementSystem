                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Pending Applicants
                                <span class="badge badge-danger"><b>
                                    <?php 
                                         $sql="SELECT COUNT(id) AS new FROM status  WHERE status.status=3  ";
