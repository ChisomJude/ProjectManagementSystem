...
<style>
	...
	h4 {
	    ...
	    <div class="form_container">
		    	...
		    	<span align="center"> <h4>School ID for this Upload must be " <?php echo $sch; ?> " </h4>
		    	            <strong> Please Ensure to Upload Excel File with these fields only <br>  School Id, Student Surname, Student firstname and Class</strong>
		    	            <br><i style="color:red"> You can verify school ID in <a href="all.php">School Registration List</a></i>
		    	        </span>
		  ...
		  <div class="col-md-8 second-half">
					...
					if(in_array($ext, $allowedExtensions)) {
						...
						if($file_size < 50) {
							...
							if($isUploaded) {
								...
								$query = "insert into `sch_records` (`sch_id`, `student_surname`, `student_firstname`, `class`) VALUES ";
